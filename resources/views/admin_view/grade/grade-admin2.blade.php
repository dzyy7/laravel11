<x-layout-admin>
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <div class="w-full md:w-1/2">
                <form action="{{ url('/admin/grades') }}" method="GET" class="flex items-center">
                    ...
                    @foreach ($grades as $grade)
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="py-3 px-4 flex space-x-4">
                                <button id="modalDetail" class="modalDetailBtn" data-name="{{ $grade->name }}"
                                    data-department="{{ $grade->department->name }}"
                                    data-students="{{ $grade->students->count() }}" data-modal-target="readGradeModal"
                                    data-modal-toggle="readGradeModal" type="button">
        ...
        <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                <dl>
                    ...
                    <dd id="modalGradeDepartment" class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400"></dd>

                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Number of Students</dt>
                    <dd id="modalGradeStudents" class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400"></dd>
                </dl>
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-3 sm:space-x-4">
                        <a type="button" href="/admin/grades/edit/{{ $grade->id }}"
    ...
    <div id="deleteModal"
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
            <h3 class="text-lg font-semibold text-gray-800">Are you sure you want to delete this grade?</h3>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function(event) {
            ...
            const modalGradeDepartment = document.getElementById('modalGradeDepartment');
            const modalGradeStudents = document.getElementById('modalGradeStudents');
            ...
            modalDetailBtns.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    modalGradeName.textContent = name;
                    modalGradeDepartment.textContent = department;
                    modalGradeStudents.textContent = students;
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function() {
                    gradeIdToDelete = this.getAttribute('data-id');
            ...
            confirmDeleteButton.addEventListener('click', function() {
                ...
                form.action = '/admin/grades/delete/' + gradeIdToDelete;
                form.submit();
            });
        });
    </script>
